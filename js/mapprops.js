...
var mapprops={ // contains all properties for the map to be displayed.
 ...
 // EDIT THIS below to change the visible map limits
  ...
  westedge:  139.0,          // Minimum longitude (degrees)
  eastedge:  148.0,          // Maximum longitude (degrees)

  southedge:  39.0,          // Minimum latitude (degrees)
  northedge:  46.0,          // Maximum latitude (degrees)

  zoomout:       4,          // Minimum zoom
  zoomin:       20,          // Maximum zoom
