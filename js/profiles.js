...
var routino={ // contains all default Routino options (generated using "--help-profile-json").
  ...
  // Speed limits
  profile_speed: {
        motorway: { foot:   0, horse:   0, wheelchair:   0, bicycle:   0, moped:  48, motorcycle: 112, motorcar: 50, goods:  96, hgv:  89, psv:  89 },
           trunk: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  48, motorcycle:  96, motorcar:  20, goods:  96, hgv:  80, psv:  80 },
         primary: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  48, motorcycle:  96, motorcar:  20, goods:  96, hgv:  80, psv:  80 },
       secondary: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  48, motorcycle:  88, motorcar:  20, goods:  88, hgv:  80, psv:  80 },
        tertiary: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  48, motorcycle:  80, motorcar:  20, goods:  80, hgv:  80, psv:  80 },
    unclassified: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  48, motorcycle:  64, motorcar:  20, goods:  64, hgv:  64, psv:  64 },
     residential: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  48, motorcycle:  48, motorcar:  10, goods:  48, hgv:  48, psv:  48 },
         service: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  32, motorcycle:  32, motorcar:  10, goods:  32, hgv:  32, psv:  32 },
           track: { foot:   4, horse:   8, wheelchair:   4, bicycle:  20, moped:  16, motorcycle:  16, motorcar:  10, goods:  16, hgv:  16, psv:  16 },
